            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-medium text-foreground">aria@musicstudio.com</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="font-medium text-foreground">New York, NY</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-muted/30 p-8 rounded-2xl">
            <form className="space-y-6">
              ...
              <div>
                ...
                <Textarea id="message" placeholder="Tell me about your project or inquiry..." rows={5} />
              </div>
